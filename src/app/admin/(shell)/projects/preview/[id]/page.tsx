...
export default async function AdminProjectPreviewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-surface text-on-surface">
      <ProjectPreviewTopbar projectId={project.id} projectTitle={project.title} published={project.published} />
      ...
      <div className="pb-24 pt-10">
        <ProjectDetailLayout
          ...
          header={
            <header className="mx-auto mb-16 max-w-[1440px] px-6 md:px-12">
              <div className="grid grid-cols-1 items-end gap-12 md:grid-cols-12">
                <div className="md:col-span-8">
                  <span className="label-md mb-4 block font-bold uppercase tracking-widest text-primary">Preview</span>
                  <h1 className="mb-6 text-[2.25rem] font-extrabold leading-[0.95] tracking-tighter md:max-w-3xl md:text-[3.25rem]">
                    {project.title}
                  </h1>
        ...
        >
          ...
          <section className="mx-auto mb-28 grid max-w-[1440px] grid-cols-1 gap-16 px-6 md:grid-cols-12 md:px-12">
          ...
          {artifacts.length > 0 && (
            <section className="mx-auto mb-28 max-w-[1440px] px-6 md:px-12">
