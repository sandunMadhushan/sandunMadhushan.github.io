  ...
  return (
    <main className="px-6 pb-20 pt-28 md:px-12">
      <section className="mx-auto mb-24 grid max-w-[1440px] grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <Skeleton className="aspect-square w-full max-w-[420px] justify-self-center rounded-xl md:justify-self-end" />
      </section>
      ...
      <section className="mx-auto max-w-[1440px]">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {Array.from({ length: 3 }).map((_, i) => (
            <div
              key={i}
              className="h-64 rounded-xl border border-outline-variant/15 bg-surface-container-low p-10"
            >
