  ...
  const projects = [
    {
      ...
      coverImage: IMG.mealbridge,
      heroImage: IMG.detailHero,
      galleryImages: [IMG.feat1, IMG.feat2],
    ...
    },
    {
      ...
      coverImage: IMG.organizer,
      heroImage: IMG.organizer,
      galleryImages: [],
      githubLink: null,
      liveLink: null,
      featured: false,
